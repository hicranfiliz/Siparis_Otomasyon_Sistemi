...
namespace Siparis_Otomasyon
{
    public partial class FrmMusteriKayit : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("Insert into musteri(adsoyad,kullaniciadi,sifre,mail,telefon,adres) values (@p1,@p2,@p3,@p4,@p5,@p6)", bgl.baglanti());
